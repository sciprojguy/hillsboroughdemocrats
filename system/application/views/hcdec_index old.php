...
<div style='width:100%'>
	<div style='width:100%;padding:4px 4px 4px 4px;'>
		<div style='margin-left:110px;margin-right;center'>
		<iframe width="420" height="315" src="http://www.youtube.com/embed/wSaqDrYwdM4" frameborder="0" allowfullscreen></iframe>
		</div>
		<p/>
...
<div style='float:left;width:150px; height:100%; background-color:white;padding-left:8px;'>
	...
	<div style='width:100%; height: 120px; overflow:auto; padding-left:8px;padding-right:8px;'>
		<?= $news_content ?>   
	</div>
</div>
